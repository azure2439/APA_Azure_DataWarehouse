CREATE TABLE [stg].[imis_Activity] (
    ...
    [LastUpdatedBy]         VARCHAR (40)    CONSTRAINT [df_activityLastUpdatedBy] DEFAULT (suser_sname()) NULL,
    [LastModified]          DATETIME        CONSTRAINT [df_activityLastModified] DEFAULT (getdate()) NULL,
    [IsActive]              BIT             NULL,
    [StartDate]             DATETIME        CONSTRAINT [df_activityStartDate] DEFAULT ('1901-01-01 00:00:00') NULL,
    [EndDate]               DATETIME        CONSTRAINT [df_activityEndtDate] DEFAULT ('2999-12-31 00:00:00') NULL,
    CONSTRAINT [PK_Activity] PRIMARY KEY NONCLUSTERED ([Id_Identity] ASC)
);


GO
CREATE NONCLUSTERED INDEX [idx_transdate]
    ON [stg].[imis_Activity]([TRANSACTION_DATE] ASC);
