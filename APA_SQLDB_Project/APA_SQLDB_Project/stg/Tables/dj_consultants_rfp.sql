CREATE TABLE [stg].[dj_consultants_rfp] (
    ...
    [LastUpdatedBy]        VARCHAR (40)    CONSTRAINT [df_consultants_LastUpdatedBy] DEFAULT (suser_sname()) NULL,
    [LastModified]         DATETIME        CONSTRAINT [df_consultants_LastModified] DEFAULT (getdate()) NULL,
