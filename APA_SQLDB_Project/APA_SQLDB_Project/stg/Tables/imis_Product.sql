CREATE TABLE [stg].[imis_Product] (
    ...
    [TITLE_KEY]               VARCHAR (MAX)    CONSTRAINT [DF_Product_TITLE_KEY] DEFAULT ('') NULL,
    [TITLE]                   VARCHAR (MAX)    CONSTRAINT [DF_Product_TITLE] DEFAULT ('') NULL,
    [DESCRIPTION]             NVARCHAR (MAX)   CONSTRAINT [DF_Product_DESCRIPTION] DEFAULT ('') NULL,
    ...
    [LastUpdatedBy]           VARCHAR (40)     CONSTRAINT [df_Product_LastUpdatedBy] DEFAULT (suser_sname()) NULL,
    [LastModified]            DATETIME         CONSTRAINT [df_Product_LastModified] DEFAULT (getdate()) NULL,
    [IsActive]                BIT              NULL,
    [StartDate]               DATETIME         CONSTRAINT [df_Product_StartDate] DEFAULT ('1901-01-01 00:00:00') NULL,
    [EndDate]                 DATETIME         CONSTRAINT [df_Product_EndtDate] DEFAULT ('2999-12-31 00:00:00') NULL,
    CONSTRAINT [PK_Product] PRIMARY KEY CLUSTERED ([Id_Identity] ASC)
);
