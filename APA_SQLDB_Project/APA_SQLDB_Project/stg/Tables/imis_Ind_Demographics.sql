CREATE TABLE [stg].[imis_Ind_Demographics] (
    ...
    [NEW_MEMBER_START_DATE]       DATETIME      NULL,
    ...
    [GENDER_OTHER]                VARCHAR (25)  DEFAULT ('') NOT NULL,
    [JOIN_SOURCE]                 VARCHAR (50)  DEFAULT ('') NOT NULL,
    [TIME_STAMP]                  BIGINT        NULL,
    [Id_Identitycolumn]           INT           IDENTITY (1, 1) NOT NULL,
    [LastUpdatedBy]               VARCHAR (40)  CONSTRAINT [df_inddemoLastUpdatedBy] DEFAULT (suser_sname()) NULL,
    [LastModified]                DATETIME      CONSTRAINT [df_inddemoLastModified] DEFAULT (getdate()) NULL,
    [IsActive]                    BIT           NULL,
    [StartDate]                   DATETIME      CONSTRAINT [df_inddemoStartDate] DEFAULT ('1901-01-01 00:00:00') NULL,
    [EndDate]                     DATETIME      CONSTRAINT [df_inddemoEndtDate] DEFAULT ('2999-12-31 00:00:00') NULL,
    CONSTRAINT [PK_Ind_Demographics] PRIMARY KEY CLUSTERED ([Id_Identitycolumn] ASC)
);
