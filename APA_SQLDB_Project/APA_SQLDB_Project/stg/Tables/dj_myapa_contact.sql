CREATE TABLE [stg].[dj_myapa_contact] (
    [id]                     INT             NOT NULL,
    ...
    [LastUpdatedBy]          VARCHAR (40)    CONSTRAINT [df_myapa_contact_LastUpdatedBy] DEFAULT (suser_sname()) NULL,
    [LastModified]           DATETIME        CONSTRAINT [df_myapa_contact_LastModified] DEFAULT (getdate()) NULL,
