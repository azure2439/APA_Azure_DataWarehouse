CREATE TABLE [stg].[dj_places_place] (
    [id]                    INT           NOT NULL,
    ...
    [LastUpdatedBy]         VARCHAR (40)  CONSTRAINT [df_places_LastUpdatedBy] DEFAULT (suser_sname()) NULL,
    [LastModified]          DATETIME      CONSTRAINT [df_places_LastModified] DEFAULT (getdate()) NULL,
