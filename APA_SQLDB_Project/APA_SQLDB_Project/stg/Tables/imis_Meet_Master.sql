CREATE TABLE [stg].[imis_Meet_Master] (
    ...
    [LastUpdatedBy]                   VARCHAR (40)    CONSTRAINT [df_Meet_Master_LastUpdatedBy] DEFAULT (suser_sname()) NULL,
    [LastModified]                    DATETIME        CONSTRAINT [df_Meet_Master_LastModified] DEFAULT (getdate()) NULL,
    [IsActive]                        BIT             NULL,
    [StartDate]                       DATETIME        CONSTRAINT [df_Meet_Master_StartDate] DEFAULT ('1901-01-01 00:00:00') NULL,
    [EndDate]                         DATETIME        CONSTRAINT [df_Meet_Master_EndtDate] DEFAULT ('2999-12-31 00:00:00') NULL,
    CONSTRAINT [PK_Meet_Master] PRIMARY KEY CLUSTERED ([Id_Identitycolumn] ASC)
);
